...
The problem: capacitors leak. A fully charged RAM cell loses its charge in just a few milliseconds. That is why your computer's memory controller constantly **refreshes** every cell by re-reading and re-writing each bit thousands of times per second, just to keep it alive.
